...
#After More EDA - Killed these columns too - used model feat importance (RF) and histogram inspection
del df_all['body_length']
del df_all['gts']
del df_all['listed']
del df_all['name_length']
del df_all['num_order']
del df_all['time_to_payout']
del df_all['time_till_event']
del df_all['CHECK']



df_all.to_csv('data/clean_data_steve.csv')
